...
const { getFontCssClass, isValidFontId, normalizeFontId } = require('../../../shared/content/fontRegistry');

/**
 * Inline font-family mark using controlled registry IDs and CSS classes.
 * Must stay in sync with client/src/components/RichEditor/extensions/bmFontFamily.ts.
 *
 ...
 */
const BmFontFamily = Mark.create({
	name: 'fontFamily',
	inclusive: true,
	keepOnSplit: true,
